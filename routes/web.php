...
Route::resource('webx', 'WebController');
...
Route::middleware(['XSS'])->namespace('Web')->group(function () {
    ...
    // SetCookie Route
    Route::get('/set-cookie', 'DashboardController@setCookie')->name('setCookie');
});
...
Route::get('locale/language/{locale}', function ($locale){
 ...
 //Route::get('/gg', 'DashboardController@index')->name('dashboard.index');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'ajax'], function() {
        ...
        Route::get('get_region/{country_id}', 'AjaxController@get_region')->name('get_region');
        Route::get('get_city/{state_id}', 'AjaxController@get_city')->name('get_city');
