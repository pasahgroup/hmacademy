...
class Student extends Admin_Controller
{
    ...
    public function view($id)
    {
        ...
        if ($this->module_lib->hasModule('behaviour_records')) {            //------- Behaviour Report Start--------
    ...
    public function edit($id)
    {
        ...
        $category                   = $this->category_model->get();
        $data['categorylist']       = $category;
         $designationList             = $this->designation_model->get();
          //$designationList                = $this->customlib->getDesignation();
