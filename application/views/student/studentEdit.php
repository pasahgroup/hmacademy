        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="<?php echo base_url("student/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
    ...
    <div class="col-md-2">
        <div class="form-group">
            <label for="exampleInputEmail1"><?php echo $this->lang->line('tribe'); ?></label>
            <input id="tribe" name="tribe" placeholder="" type="text" class="form-control"  value="<?php echo set_value('tribe', $student['tribe']); ?>" />
            <span class="text-danger"><?php echo form_error('tribe');?></span>
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <select  id="designation" name="designation" class="form-control" >
                ...
                <?php foreach ($designationList as $designation) {?>
                    <option value="<?php echo $designation['designation'] ?>" <?php
  if ($student['designation'] == $designation['designation']) {
  echo "selected=selected";
  }
...
<?php echo $this->lang->line('other_details'); ?></label></label>
      </h4>

    <div class="col-md-2">
        <div class="form-group">
            <label for="exampleInputEmail1"><?php echo $this->lang->line('parent_status'); ?></label>
            <select  id="parent_status" name="parent_status" class="form-control" >
                <option value="<?php echo set_value('parent_status', $student['parent_status']); ?>"><?php echo set_value('parent_status', $student['parent_status']); ?></option>
            ...
            <span class="text-danger"><?php echo form_error('parent_status'); ?></span>
        </div>
    </div>

    <div class="col-md-2">
        <div class="form-group">
            <label for="exampleInputEmail1"><?php echo $this->lang->line('education_level'); ?></label>
            <select  id="education_level" name="education_level" class="form-control" >

                <option value="<?php echo set_value('education_level', $student['education_level']); ?>"><?php echo set_value('education_level', $student['education_level']); ?></option>
 <option value="">--Standard Seven--</option>
 ...
 $('.sibling_msg').html("<div class='alert alert-danger text-center'> <?php echo $this->lang->line('no_student_selected'); ?> </div>");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#parent_status').val(data.parent_status);
