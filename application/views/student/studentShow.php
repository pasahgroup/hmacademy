...
if (!empty($stvalue["image"])) {
                    ...
                    if ($student['gender'] == 'Female') {
                        ...
                        // echo "localhost/hmacademy/uploads/student_images/default_male.jpg";
...
if ($sch_setting->roll_no) {
    ?>
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('designation'); ?></b> <a class="pull-right text-aqua"> <?php echo $student['designation']; ?></a>
                            </li>
...
($sch_setting->religion) {?>
                                            ...
                                            <tr>
                                                <td><?php echo $this->lang->line('tribe'); ?></td>
                                                <td><?php echo $student['tribe']; ?></td>
                                            </tr>
