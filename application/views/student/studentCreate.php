...
?>
                                      ...
                                      <div class="col-md-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('tribe'); ?></label><small class="req"></small>
                                                <input id="tribe" name="tribe" placeholder="" type="text" class="form-control"  value="<?php echo set_value('tribe'); ?>" />
                                      ...
                                      if (set_value('designation') == $designation['designation']) {
                                      echo "selected=selected";
                                      }
  ...
  <?php echo $this->lang->line('other_details'); ?></label></label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('parent_status'); ?></label><small class="req"> *</small>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('education_level'); ?></label><small class="req"></small>
