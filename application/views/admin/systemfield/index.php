...
?> />
                                    ...
                                    <tr>
                                       <td class="text-rtl-right" width="100%"><?php echo $this->lang->line('tribe'); ?></td>
                                       <td>
                                           <div class="material-switch pull-right">
                                               <input id="tribe" name="tribe" type="checkbox" data-role="tribe" class="chk" data-rowid="1" value="checked" <?php if ($result->tribe == "1") {
                        echo "checked='checked'";
                        }
                        ?> />
                                               <label for="tribe" class="label-success"></label>
                                           </div>
                                       </td>
                                   </tr>
