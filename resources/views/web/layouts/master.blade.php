...
<link href="../../web/css/meanmenu.css" rel="stylesheet">
<link href="../../web/css/slick.css" rel="stylesheet">
<link href="../../web/css/dripicons.css" rel="stylesheet">
                                ...
                                <ul>
                                    <li>
                                        <div class="second-header-btn">
                                           <a href="{{ route('application.index') }}" target="_blank" class="btn">{{ __('navbar_register') }}</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
