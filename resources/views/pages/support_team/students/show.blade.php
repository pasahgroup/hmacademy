...
@section('page_title', 'Student Profile - '.$sr->user->name.' '.$sr->user->middle_name.' '.$sr->user->surname)
@section('content')
<div class="row">
    <div class="col-md-3 text-center">
        <div class="card">
            <div class="card-body">
                ...
                <br>
                <h3 class="mt-3">{{ $sr->user->name }} {{ $sr->user->middle_name }} {{ $sr->user->surname }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item">
                        <a href="#" class="nav-link active">{{ $sr->user->name }} {{ $sr->user->middle_name }} {{ $sr->user->surname }}</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade show active" id="basic-info">
                        <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td>{{ $sr->user->name }} {{ $sr->user->middle_name }} {{ $sr->user->surname }}</td>
                            </tr>
                            <tr>
