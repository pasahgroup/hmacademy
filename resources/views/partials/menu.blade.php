<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
                            ...
                            @if(Qs::userIsTeamSA())
                                <li class="nav-item">
                                    <a href="{{ route('students.create') }}"
                                       class="nav-link {{ (Route::is('students.create')) ? 'active' : '' }}">Register Student</a>
                                </li>
                            @endif
  ...
  {{--Settings--}}
                @if(Qs::userIsTeamSAT())
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['application-setting.index', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        <a href="#" class="nav-link"><i class="icon-users"></i> <span>Settings</span></a>
                            ...
                            @if(Qs::userIsTeamSA())
                                <li class="nav-item">
                                    <a href="{{ route('application-setting.index') }}"
                                       class="nav-link {{ (Route::is('application-setting.index')) ? 'active' : '' }}">Online Admission</a>
                                </li>
